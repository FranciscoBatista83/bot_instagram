...
class DashboardTab(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        # ===== ABA REELS =====
        reels_tab = self.config_tabview.tab("🎬 Vídeos")
    ...
    def load_unfollow_configs(self):
        """Carrega as configurações de unfollow do arquivo JSON (converte segundos para minutos na interface)."""
        config_file = os.path.join(os.path.dirname(__file__), "..", "bot_configs.json")
        ...
        if os.path.exists(config_file):
            try:
                ...
                # Carregar pausa mínima entre lotes (converter segundos para minutos)
                ...
                # Carregar pausa máxima entre lotes (converter segundos para minutos)
                ...
                print(f"Erro ao carregar configurações de unfollow: {e}")

    def save_unfollow_configs(self):
        """Salva as configurações de unfollow em um arquivo JSON (converte minutos para segundos)."""
        config_file = os.path.join(os.path.dirname(__file__), "..", "bot_configs.json")
        ...
        try:
            ...
            # Atualizar configurações de unfollow
            ...
            print(f"Erro ao salvar configurações de unfollow: {e}")
            return False

    def save_unfollow_configs_action(self):
        """Ação do botão salvar configurações de unfollow."""
        if self.save_unfollow_configs():
            self.status_label.configure(
                text="✅ Configurações de unfollow salvas com sucesso!", text_color="green"
            )
        else:
            self.status_label.configure(
                text="❌ Erro ao salvar configurações de unfollow!", text_color="red"
            )

    def load_follow_configs(self):
        """Carrega as configurações de follow do arquivo JSON."""
        config_file = os.path.join(os.path.dirname(__file__), "..", "bot_configs.json")
        ...
        if os.path.exists(config_file):
            try:
                ...
                print(f"Erro ao carregar configurações de follow: {e}")

    def save_follow_configs(self):
        """Salva as configurações de follow em um arquivo JSON (converte minutos para segundos)."""
        config_file = os.path.join(os.path.dirname(__file__), "..", "bot_configs.json")
        ...
        try:
            ...
            # Atualizar configurações de follow
            ...
            print(f"Erro ao salvar configurações de follow: {e}")
            return False

    def save_follow_configs_action(self):
        """Ação do botão salvar configurações de follow."""
        if self.save_follow_configs():
            self.status_label.configure(
                text="✅ Configurações de follow salvas com sucesso!", text_color="green"
            )
        else:
            self.status_label.configure(
                text="❌ Erro ao salvar configurações de follow!", text_color="red"
            )
